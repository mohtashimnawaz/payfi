    ...
    <div className="w-full max-w-[1000px] mx-auto">
      ...
      <div className="text-center mb-32 animate-reveal relative">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-transparent border border-[#e6e9ef] mb-10">
          ...
          <span className="text-[10px] font-medium uppercase tracking-[0.2em] text-muted">Protocol Live on Devnet</span>
        </div>
        
        <h1 className="text-[72px] md:text-[96px] font-semibold tracking-[-0.05em] leading-[0.9] text-body mb-10 text-balance">
          Privacy for the <br /> <span className="prism-text">next billion.</span>
        </h1>
        
        <p className="text-lg text-muted max-w-[540px] mx-auto leading-relaxed text-balance mb-14 font-medium">
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 gap-5 mb-32">
        ...
        <Link href="/deposit" className="md:col-span-4 group">
          <div className="card h-full flex flex-col justify-between relative overflow-hidden">
            ...
            <div>
              ...
              <h2 className="text-3xl font-medium text-body mb-4 tracking-tight">Private Deposits</h2>
              <p className="text-muted leading-relaxed max-w-[320px] font-medium">
                Shield your tokens in our secure vault using advanced ZK commitments.
              </p>
            </div>
            <div className="mt-16 flex items-end justify-between">
              <div className="text-[12px] font-medium text-muted group-hover:text-body transition-colors duration-500">
                Start Shielding →
              </div>
              <div className="w-20 h-20 rounded-2xl bg-transparent border border-[#e6e9ef] flex items-center justify-center group-hover:scale-110 transition-transform duration-700">
                <div className="w-7 h-7 border-[1.5px] border-[#e6e9ef] rounded-full border-t-indigo-400 animate-spin-slow" />
              </div>
            </div>
          </div>
        </Link>
        ...
        <Link href="/withdraw" className="md:col-span-2 group">
          <div className="card h-full flex flex-col justify-between">
            ...
            <h2 className="text-2xl font-medium text-body mb-4 tracking-tight">Withdraw</h2>
            <p className="text-sm text-muted leading-relaxed font-medium">
                Redeem your assets with cryptographic proofs.
              </p>
            </div>
            <div className="mt-16 text-[12px] font-medium text-muted group-hover:text-body transition-colors duration-500">
              Redeem →
            </div>
          </div>
        </Link>
        ...
        <Link href="/admin" className="md:col-span-2 group">
          <div className="card h-full py-8">
            <h3 className="text-lg font-medium text-body mb-2 tracking-tight">Admin</h3>
            <p className="text-sm text-muted font-medium">Protocol control.</p>
          </div>
        </Link>

        <Link href="/relayer" className="md:col-span-2 group">
          <div className="card h-full py-8">
            <h3 className="text-lg font-medium text-body mb-2 tracking-tight">Relayers</h3>
            <p className="text-sm text-muted font-medium">Network nodes.</p>
          </div>
        </Link>

        <div className="md:col-span-2 card py-8 flex items-center justify-between">
          <div>
            <h3 className="text-lg font-medium text-body mb-1 tracking-tight">Status</h3>
      ...
      {/* Footer Info */}
      <div className="border-t border-[#e6e9ef] pt-32 pb-32 text-center">
        <h3 className="text-[10px] font-medium uppercase tracking-[0.4em] text-muted mb-16">Built for Solana</h3>
