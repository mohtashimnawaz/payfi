...
export default function WithdrawPage() {
  ...
  return (
    <div className="reveal">
      <div className="mb-16">
        <h1 className="text-5xl font-semibold text-body mb-6 tracking-tighter">Withdraw <span className="prism-text">Funds</span></h1>
        <p className="text-muted text-xl max-w-2xl font-medium leading-relaxed">Withdraw tokens with valid zero-knowledge proofs or relayer attestation.</p>
      </div>
      ...
      <BentoGrid>
        ...
        <Card title="Requirements" badge="Important">
          <div className="space-y-6 text-muted text-sm leading-relaxed font-medium">
            ...
            <p className="pt-6 border-t border-[#e6e9ef] text-xs italic">
