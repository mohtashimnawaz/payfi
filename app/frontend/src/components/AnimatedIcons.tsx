...
export function CurrencyIcon({ size = 24, className = '', animate = true }: AnimatedIconProps) {
  return (
    <motion.svg
      width={size}
      height={size}
...
export function GlobeIcon({ size = 24, className = '', animate = true }: AnimatedIconProps) {
  return (
    <motion.svg
      width={size}
      height={size}
...
export function BoltIcon({ size = 24, className = '', animate = true }: AnimatedIconProps) {
  return (
    <motion.svg
      width={size}
      height={size}
...
export function WarningIcon({ size = 24, className = '', animate = true }: AnimatedIconProps) {
  return (
    <motion.svg
      width={size}
      height={size}
...
export function UsersIcon({ size = 24, className = '', animate = true }: AnimatedIconProps) {
  return (
    <motion.svg
      width={size}
      height={size}
...
export function SettingsIcon({ size = 24, className = '', animate = true }: AnimatedIconProps) {
  return (
    <motion.svg
      width={size}
      height={size}
